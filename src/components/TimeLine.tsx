    ...
    return (
        <section className="py-24" id="experience">
            <div className="flex flex-col gap-6 px-4 mx-auto justify-center items-center">
                <h2 className="text-2xl md:text-3xl xl:text-4xl text-center font-bold font-heading font-heading tracking-px-n leading-none text-orange-500">Experience</h2>
                ...
                <div className="relative max-w-[80%]">
                    <div className="absolute left-1/2 top-0 h-full w-0.5 bg-orange-800" />
