    ...
    return (
        <section className="py-24" id="projects">
            <div className="flex flex-col gap-6 px-4 mx-auto">
                <h2 className="text-2xl md:text-3xl xl:text-4xl text-center font-bold font-heading font-heading tracking-px-n leading-none text-white">Current Projects</h2>
                ...
                <div className="mx-auto flex items-center justify-center">
                    <div className="flex-wrap grid sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-3 max-w-[80%]">
